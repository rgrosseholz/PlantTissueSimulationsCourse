...
void PracticalSession::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2)
{
...
void PracticalSession::SetCellColor(CellBase *c, QColor *color)
{ 
...
void PracticalSession::CellHouseKeeping(CellBase *c)
{
...
void PracticalSession::CelltoCellTransport(Wall *w, double *dchem_c1, double *dchem_c2)
{
...
void PracticalSession::WallDynamics(Wall *w, double *dw1, double *dw2)
{
...
double PracticalSession::complex_PijAj(CellBase *here, CellBase *nb, Wall *w)
{ 
...
void PracticalSession::CellDynamics(CellBase *c, double *dchem)
{
  ...
  dPidt = -par->k1 * c->ReduceCellAndWalls<double>( far_3_arg_mem_fun( *this, &PracticalSession::complex_PijAj ) ) + par->k2 * sum_Pij;
