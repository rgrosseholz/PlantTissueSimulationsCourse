...
class Exercise2 : public QObject, SimPluginInterface {
  Q_OBJECT
  Q_INTERFACES(SimPluginInterface);
    Q_PLUGIN_METADATA(IID "org.virtualleaf.Exercise2")


 public:
  virtual QString ModelID(void) { return QString( "Exercise 2 - Understanding signalling patterns" ); }
  ...
  virtual QString DefaultLeafML(void) { return QString("Exercise2.xml"); }
